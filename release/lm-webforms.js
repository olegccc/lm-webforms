...
define('text!views/fileRead.html',[],function () { return '<input type="file" style="display: none"/><md-button ng-click="chooseFile()"><md-icon>attach_file</md-icon></md-button><md-button ng-click="clear()" ng-show="valueSet"><md-icon>clear</md-icon></md-button><span>{{comment}}</span>';});
