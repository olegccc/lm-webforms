...
var templates = {
    ...
    "views/fileRead.jade": "<input type=\"file\" style=\"opacity: 0; height: 0; width: 0; display: inline\"/><md-button ng-click=\"chooseFile()\"><md-icon>attach_file</md-icon></md-button><md-button ng-click=\"clear()\" ng-show=\"valueSet\"><md-icon>clear</md-icon></md-button><span>{{comment}}</span>",
    ...
    "views/inputFields/image.jade": "<label>{{field.title | translate}}</label><div><div><input ng-if=\"!readOnly(field)\" type=\"file\" fileread=\"object[field.property]\"/></div><div style=\"margin-top: 1em;\"><img ng-if=\"object[field.property] != null\" ng-src=\"/Image/Thumbnail/{{object[field.property]}}\"/></div></div>",
