(function() { function ___f$(angular,Autolinker,Recaptcha) {/*
...
} if (typeof define === 'function' && define.amd) { define(["angular","angular.animate","angular.translate","angular.messages","angular.material","angular.aria","angular.touch","autolinker","recaptcha"], function (angular,$_v0,$_v1,$_v2,$_v3,$_v4,$_v5,Autolinker,Recaptcha) { ___f$(angular,Autolinker,Recaptcha); }); } else if (typeof exports === 'object') { var angular = require('angular');var Autolinker = require('autolinker');var Recaptcha = require('recaptcha');require('angular.animate');require('angular.translate');require('angular.messages');require('angular.material');require('angular.aria');require('angular.touch'); module.exports = ___f$(angular,Autolinker,Recaptcha); } else  { ___f$(angular,Autolinker,Recaptcha); } })();