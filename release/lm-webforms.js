...
} if (typeof define === 'function' && define.amd) { define(["angular","angular.animate","angular.translate","angular.messages","angular.material","angular.aria","angular.touch","autolinker","recaptcha"], function ($_v0,$_v1,$_v2,$_v3,$_v4,$_v5,$_v6,$_v7,$_v8) { ___f$($_v0,$_v7,$_v8); }); } else if (typeof exports === 'object') { var $_v0 = require('angular');var $_v7 = require('autolinker');var $_v8 = require('recaptcha');require('angular.animate');require('angular.translate');require('angular.messages');require('angular.material');require('angular.aria');require('angular.touch'); module.exports = ___f$($_v0,$_v7,$_v8); } else  { ___f$(angular,Autolinker,Recaptcha); } })();